...
include PHPAES_ROOT . '/phpseclib/Crypt/Hash.php';
include PHPAES_ROOT . '/phpseclib/Common/Functions/Strings.php';
include PHPAES_ROOT . '/phpseclib/Math/BigInteger.php';
