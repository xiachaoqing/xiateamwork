 ...
 * @author      XCQ
 * @package     project
 * @version     $Id: story.html.php 5117 2019-03-11 07:03:14Z 631753810@qq.com $
*/
?>
...
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-left">
    <?php if(common::hasPriv('project', 'story')) echo html::a($this->createLink('project', 'story', "projectID=$project->id"), "<span class='text'>{$lang->story->allStories}</span> <span class='label label-light label-badge'></span>", '', "class='btn btn-link t'");?>

    <?php echo html::a($this->createLink('project', 'unstory', "projectID=$project->id"), "<span class='text'>{$lang->story->unclosed}</span> <span class='label label-light label-badge'>{$pager->recTotal}</span>", '', "class='btn btn-link btn-active-text'");?>
      ...
      <div class='table-footer'>
        ...
        <div class='table-actions btn-toolbar'>
          ...
          <div class="btn-group dropup">
            ...
            $actionLink = $this->createLink('story', 'batchAssignTo', "projectID=$project->id");
