...
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-left">
    ...
    <?php echo html::a($this->createLink('project', 'unstory', "projectID=$project->id"), "<span class='text'>{$lang->story->unclosed}</span> <span class='label label-light label-badge'>{$pager->recTotal}</span>", '', "class='btn btn-link'");?>
