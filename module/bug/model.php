 ...
 * @author      XCQ
 * @package     bug
 * @version     $Id: model.php 5079 2013-07-10 00:44:34Z 631753810@qq.com $
*/
?>
<?php
class bugModel extends model
{
     ...
     * @return void
     */
    public function getUserBugs1($account,$begin,$end,$type = 'assignedTo', $orderBy = 'id_desc', $limit = 0, $pager = null)
    {
        if(!$this->loadModel('common')->checkField(TABLE_BUG, $type)) return array();
        $bugs = $this->dao->select('*')->from(TABLE_BUG)
            ->where('deleted')->eq(0)
