          ...
          <table class='table table-condensed table-striped table-bordered table-fixed no-margin' id="workload">
            ...
            <tbody>
              ...
              <tr class="text-center">
                <td rowspan="<?php echo count($load['task']);?>"><?php echo html::a($this->createLink('report', 'view', "account=$account&begin=".strtotime($begin)."&end=".strtotime($end)),$users[$account]);?></td>
                <?php $id = 1;?>
