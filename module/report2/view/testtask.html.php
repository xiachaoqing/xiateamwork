...
<div id='mainContent'>
  <nav id='contentNav'>
    <ul class='nav nav-default'>
      <?php
      echo "<li class='active'>"  . html::a($this->createLink('report', 'testtask', "account=$account&begin=".strtotime($begin)."&end=".strtotime($end)),  $lang->user->testTask2Him) . "</li>";
      echo "<li>"  . html::a($this->createLink('report', 'testcase', "account=$account&begin=".strtotime($begin)."&end=".strtotime($end)."&type=case2Him"),  $lang->user->case2Him) . "</li>";
      echo "<li>" . html::a($this->createLink('report', 'testcase', "account=$account&begin=".strtotime($begin)."&end=".strtotime($end)."&type=caseByHim"),  $lang->user->caseByHim) . "</li>";
      ?>
    </ul>
  </nav>
