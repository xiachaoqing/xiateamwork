...
<div id='mainContent'>
  <nav id='contentNav'>
    <ul class='nav nav-default'>
      ...
      echo "<li class='$active'>" . html::a(inlink('bug', "account=$account&begin=".strtotime($begin)."&end=".strtotime($end)."&type=assignedTo"), $lang->user->assignedTo) . "</li>";

      $active = $type == 'openedBy' ? 'active' : '';
      echo "<li class='$active'>" . html::a(inlink('bug', "account=$account&begin=".strtotime($begin)."&end=".strtotime($end)."&type=openedBy"),   $lang->user->openedBy)   . "</li>";

      $active = $type == 'resolvedBy' ? 'active' : '';
      echo "<li class='$active'>" . html::a(inlink('bug', "account=$account&begin=".strtotime($begin)."&end=".strtotime($end)."&type=resolvedBy"), $lang->user->resolvedBy) . "</li>";

      $active = $type == 'closedBy' ? 'active' : '';
      echo "<li class='$active'>" . html::a(inlink('bug', "account=$account&begin=".strtotime($begin)."&end=".strtotime($end)."&type=closedBy"),   $lang->user->closedBy)   . "</li>";
      ?>
    </ul>
  </nav>
