 ...
 * @author      XCQ
 * @package     ZenTaoPMS
 * @version     $Id: zh-cn.php 5116 2019-03-11 06:37:48Z 631753810@qq.com $
*/
...
$lang->project->menu->story   = array('link' => '需求|project|unstory|projectID=%s', 'subModule' => 'unstory', 'alias' => 'linkstory,storykanban');
...
$lang->report->menu->product = array('link' => $lang->productCommon . '|report|producttime','alias' => 'productsummary,financetime');
...
$lang->report->menu->staff   = array('link' => '组织|report|tasktime','alias' => 'taskload');
